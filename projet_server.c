...
struct AbonnementCompte * supprimercompte_1_svc(struct AbonnementCompte *monCompte, struct svc_req *rqstp) {
    static struct AbonnementCompte result; 
...
void * affichercompte_1_svc(AbonnementCompte *monCompte) {
    if (monCompte != NULL) {
...
// Implémentation de la fonction afficherAbonnement
void * afficherabonnement_1_svc(AbonnementCompte *monCompte) {
    if (monCompte != NULL) {
